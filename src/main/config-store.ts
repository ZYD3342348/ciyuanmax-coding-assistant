...
const defaults: ConfigSchema = {
    ...
    encryptedKeys: {},
    baseUrls: {
        anthropic: 'https://llm.ciyuanmax.art',
        openai: 'https://llm.ciyuanmax.art/v1',
    },
...
export class ConfigStore {
    ...
    constructor() {
        this.store = new Store<ConfigSchema>({
            name: 'ciyuanmax-coding-assistant-config',
            defaults,
        });
    }
    ...
    getModel(provider: string): string | null {
        const models = this.store.get('models', defaults.models);
